...
class DUTCSR_in_agent_xaction:
    ...
    def Step(self, cycles: int = 1):
        ...
        for i in range(cycles):
            ...
            # Check if CSR_in_agent_xaction is dirty
            _is_CSR_in_agent_xaction_dirty = self._is_first_step or any([
                self.io_csr_intrBitSet.dirty,
                self.io_csr_wfiEvent.dirty,
                self.io_csr_criticalErrorState.dirty,
                self.io_snpt_snptDeq.dirty,
                self.io_snpt_useSnpt.dirty,
                self.io_snpt_snptSelect.dirty,
                self.io_snpt_flushVec_0.dirty,
                self.io_snpt_flushVec_1.dirty,
                self.io_snpt_flushVec_2.dirty,
                self.io_snpt_flushVec_3.dirty,
                self.io_wfi_safeFromMem.dirty,
                self.io_wfi_safeFromFrontend.dirty,
                self.io_wfi_enable.dirty,
                self.io_fromVecExcpMod_busy.dirty,
                self.io_readGPAMemData_gpaddr.dirty,
                self.io_readGPAMemData_isForVSnonLeafPTE.dirty,
                self.io_vstartIsZero.dirty,
                self.io_debugEnqLsq_canAccept.dirty,
                self.io_debugEnqLsq_needAlloc_0.dirty,
                self.io_debugEnqLsq_needAlloc_1.dirty,
                self.io_debugEnqLsq_needAlloc_2.dirty,
                self.io_debugEnqLsq_needAlloc_3.dirty,
                self.io_debugEnqLsq_needAlloc_4.dirty,
                self.io_debugEnqLsq_needAlloc_5.dirty,
                self.io_debugEnqLsq_req_0_valid.dirty,
                self.io_debugEnqLsq_req_0_bits_robIdx_value.dirty,
                self.io_debugEnqLsq_req_0_bits_lqIdx_value.dirty,
                self.io_debugEnqLsq_req_1_valid.dirty,
                self.io_debugEnqLsq_req_1_bits_robIdx_value.dirty,
                self.io_debugEnqLsq_req_1_bits_lqIdx_value.dirty,
                self.io_debugEnqLsq_req_2_valid.dirty,
                self.io_debugEnqLsq_req_2_bits_robIdx_value.dirty,
                self.io_debugEnqLsq_req_2_bits_lqIdx_value.dirty,
                self.io_debugEnqLsq_req_3_valid.dirty,
                self.io_debugEnqLsq_req_3_bits_robIdx_value.dirty,
                self.io_debugEnqLsq_req_3_bits_lqIdx_value.dirty,
                self.io_debugEnqLsq_req_4_valid.dirty,
                self.io_debugEnqLsq_req_4_bits_robIdx_value.dirty,
                self.io_debugEnqLsq_req_4_bits_lqIdx_value.dirty,
                self.io_debugEnqLsq_req_5_valid.dirty,
                self.io_debugEnqLsq_req_5_bits_robIdx_value.dirty,
                self.io_debugEnqLsq_req_5_bits_lqIdx_value.dirty,
                self.io_debugInstrAddrTransType_bare.dirty,
                self.io_debugInstrAddrTransType_sv39.dirty,
                self.io_debugInstrAddrTransType_sv39x4.dirty,
                self.io_debugInstrAddrTransType_sv48.dirty,
                self.io_debugInstrAddrTransType_sv48x4.dirty,
                self.io_storeDebugInfo_0_robidx_value.dirty,
                self.io_storeDebugInfo_1_robidx_value.dirty,
                self.compare.dirty,
                self.CSR_in_agent_xaction.dirty,
                self.super_result.dirty,
                ])

            if _is_CSR_in_agent_xaction_dirty:
                ...
                self.io_csr_intrBitSet.dirty = False
                self.io_csr_wfiEvent.dirty = False
                self.io_csr_criticalErrorState.dirty = False
                self.io_snpt_snptDeq.dirty = False
                self.io_snpt_useSnpt.dirty = False
                self.io_snpt_snptSelect.dirty = False
                self.io_snpt_flushVec_0.dirty = False
                self.io_snpt_flushVec_1.dirty = False
                self.io_snpt_flushVec_2.dirty = False
                self.io_snpt_flushVec_3.dirty = False
                self.io_wfi_safeFromMem.dirty = False
                self.io_wfi_safeFromFrontend.dirty = False
                self.io_wfi_enable.dirty = False
                self.io_fromVecExcpMod_busy.dirty = False
                self.io_readGPAMemData_gpaddr.dirty = False
                self.io_readGPAMemData_isForVSnonLeafPTE.dirty = False
                self.io_vstartIsZero.dirty = False
                self.io_debugEnqLsq_canAccept.dirty = False
                self.io_debugEnqLsq_needAlloc_0.dirty = False
                self.io_debugEnqLsq_needAlloc_1.dirty = False
                self.io_debugEnqLsq_needAlloc_2.dirty = False
                self.io_debugEnqLsq_needAlloc_3.dirty = False
                self.io_debugEnqLsq_needAlloc_4.dirty = False
                self.io_debugEnqLsq_needAlloc_5.dirty = False
                self.io_debugEnqLsq_req_0_valid.dirty = False
                self.io_debugEnqLsq_req_0_bits_robIdx_value.dirty = False
                self.io_debugEnqLsq_req_0_bits_lqIdx_value.dirty = False
                self.io_debugEnqLsq_req_1_valid.dirty = False
                self.io_debugEnqLsq_req_1_bits_robIdx_value.dirty = False
                self.io_debugEnqLsq_req_1_bits_lqIdx_value.dirty = False
                self.io_debugEnqLsq_req_2_valid.dirty = False
                self.io_debugEnqLsq_req_2_bits_robIdx_value.dirty = False
                self.io_debugEnqLsq_req_2_bits_lqIdx_value.dirty = False
                self.io_debugEnqLsq_req_3_valid.dirty = False
                self.io_debugEnqLsq_req_3_bits_robIdx_value.dirty = False
                self.io_debugEnqLsq_req_3_bits_lqIdx_value.dirty = False
                self.io_debugEnqLsq_req_4_valid.dirty = False
                self.io_debugEnqLsq_req_4_bits_robIdx_value.dirty = False
                self.io_debugEnqLsq_req_4_bits_lqIdx_value.dirty = False
                self.io_debugEnqLsq_req_5_valid.dirty = False
                self.io_debugEnqLsq_req_5_bits_robIdx_value.dirty = False
                self.io_debugEnqLsq_req_5_bits_lqIdx_value.dirty = False
                self.io_debugInstrAddrTransType_bare.dirty = False
                self.io_debugInstrAddrTransType_sv39.dirty = False
                self.io_debugInstrAddrTransType_sv39x4.dirty = False
                self.io_debugInstrAddrTransType_sv48.dirty = False
                self.io_debugInstrAddrTransType_sv48x4.dirty = False
                self.io_storeDebugInfo_0_robidx_value.dirty = False
                self.io_storeDebugInfo_1_robidx_value.dirty = False
                self.compare.dirty = False
                self.CSR_in_agent_xaction.dirty = False
                self.super_result.dirty = False
